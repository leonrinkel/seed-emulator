...
class KuboServer(Server):
    ...
    def install(self, node: Node):
        ...
        node.addBuildCommand('git clone https://git.leon.fyi/ipfs/kubo')
        ...
        node.appendStartCommand('/kubo/cmd/ipfs/ipfs config --json Swarm.Transports.Network \'{"QUIC": true, "SCIONQUIC": false}\'')
